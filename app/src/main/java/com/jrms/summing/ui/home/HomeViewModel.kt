...
class HomeViewModel(application: Application, private val webServiceRepository: WebServiceRepository) : AndroidViewModel(application) {
    ...
    fun getSpendList() {
        webServiceRepository.serviceTransport.getLastTransport().enqueue(object : Callback<List<Spend>>{
